...
<body>
<h1>Sector NorEste Nº9</h1>
<?php 
include '../config.php';
$querys = "SELECT * FROM t_sector WHERE Id_sector = 18";  
...
<?php
include '../config.php';
$queryi = "SELECT t_isla.Id_isla, t_isla.Isla FROM t_isla WHERE Idsector = 18 ORDER BY t_isla.Id_isla ASC";  
