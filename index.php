...
<div id="page">
   ...
   <a href="./ins/insertisla1.php" target="frame">I.Islas</a><br>
   <a href="./ins/insertciud1.php" target="frame">I.Ciudad</a><br>
   <br>
   <a href="./ciuxjug.php" target="frame">Ciudades X Jugador</a><br>
   <a href="./jugxali.php" target="frame">Jugadores X Alianza</a><br>
   ...
   <a href="./mod/modif.php" target="frame">Modificaciones</a><br>
    ...
    <section id="main">
      <iframe name="frame" src="./start.htm">
    
      </iframe>
    </section>
    <footer>
      <p>Alianza La Ultima Legion - Ikariam - ES - Medusa</p>
    </footer>
  </div>
</body>
</html>
